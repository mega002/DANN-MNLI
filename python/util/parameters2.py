...
parser.add_argument("--lmbda_rate", type=float, default=2., help="Increasing rate for domain cost regularization")
parser.add_argument("--num_epochs", type=int, default=0, help="Number of epoches for training, 0 for early stopping (default)")
