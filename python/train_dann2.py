        ...
        while True:
            ...
            for i in range(self.total_batch):
                ...
                if self.step % self.display_step_freq == 0:
                    ...
                    logger.Log("step: %d\tmatched-dev acc: %r" % (self.step, dev_acc_mat))
                    ...
                    acclog.write("{},{},{}\n".format(self.step, dev_sgenre_acc, dev_tgenre_acc))
                ...
                p = float(self.step) / float(self.total_batch * self.batch_size)
            ...
            if (progress < 0.1) or (self.step > self.best_step + 10000):
                ...
                logger.Log("Best sgenre-dev accuracy: %s" % (self.best_dev_sgenre_acc))
...
if test == False:
    ...
    acclog.write("step,sgenre_dev_acc,tgenre_dev_acc\n")
